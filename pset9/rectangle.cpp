...
Rectangle rectangle_union(Rectangle const & r1, Rectangle const & r2)
{
    ...
    double maxx1 = std::min(r1.p1().x(), r2.p1().x());
    double maxy1 = std::min(r1.p1().y(), r2.p1().y());
...
Rectangle rectangle_intersection(Rectangle const & r1, Rectangle const & r2)
{
    ...
    double maxx1 = std::min(r1.p1().x(), r2.p0().x());
    double maxy1 = std::min(r1.p1().y(), r2.p0().y());
